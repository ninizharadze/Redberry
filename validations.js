...
let valid = () =>{
    ...
    if(about == " "){
        document.getElementById('about').style.border = '1px solid #EF5050';
    }else{
        document.getElementById('about').style.border = '1px solid #98E37E';
    }
...
let validExperience = () =>{
    ...
    if(description == " "){
        document.getElementById('description').style.border = '1px solid #EF5050';
    }else{
        document.getElementById('description').style.border = '1px solid #98E37E';
    }
...
let validEdu = () =>{
    ...
    if(eduDescription == " "){
        document.getElementById('eduDescription').style.border = '1px solid #EF5050';
    }else{
        document.getElementById('eduDescription').style.border = '1px solid #98E37E';
    }
